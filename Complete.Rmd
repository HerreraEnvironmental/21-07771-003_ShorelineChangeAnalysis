...
Look at a single profile and year to see the applied linear regression. On the right, the linear quartiles are added for more detailed data description of accretion and erosion. These quartiles are labeled "minimum", "quartile1", "median", "quartile3", and "maximum" in accordance with boxplot parameters.
