...
-   Profile 26, one of the Leadbetter Point profiles, falls in a very small 'erosion' window on the WCEHA dataset on an otherwise accreting peninsula. This slice of land is also the site of vegetation clearance for snowy plover habitat, potentially complicating the aerial-imagery-based WCEHA designation.
