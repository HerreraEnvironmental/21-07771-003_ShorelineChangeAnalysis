...
*TODO: Add quartile and rate change descriptions here, including annualized*
Characterizing the profiles with more points allows for a more detailed look at erosion and accretion. 
```{r, echo=FALSE}
profile.pattern <- "prof"
