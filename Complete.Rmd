...
```{r, echo=FALSE}
profile.pattern <- "prof_6|prof_7|prof_8|prof_9|prof_17|prof_22|prof_41"
source("scripts/src/import_profiles.R")
```
Take a preliminary look at the profiles compared to the BasePoint as a reference for Euclidean distance change. 
