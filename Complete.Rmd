...
*TODO check this* The regression t-Test is applied to test if the slope, β1 , of the population regression line equals 0 .
Based on that test we may decide whether x is a useful (linear) predictor of y .
