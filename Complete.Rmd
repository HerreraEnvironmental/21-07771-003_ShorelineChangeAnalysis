...
Naming convention is prof_X_ttYY.out where prof is short for profile, X is the profile number, tt is a season code (e.g. f = fall) and YY is the year, in the format of the last two digits (i.e, "98" is 1998", "00" is 2000, "08" is 2008, etc).
...
## Assign status to each profile
```{r prep, echo=FALSE}
knitr::kable(results.table, caption = "Change status of each profile")
```
